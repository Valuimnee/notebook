...
<form class="container-fluid notes-grid text-center pb-5 mt-3" name="notes-form" method="post" action="/view-note">
                ...
                <c:if test="${4*loop.index+element.index lt notes.size()}">
                    <div class="col-sm-3 pl-0 pr-0">
                        <div class="card bicycle-card">
                            ...
                            <div class="card-header text-center text note-title">${note.title}</div>
                            <div class="card-body">
