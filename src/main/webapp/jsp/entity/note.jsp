...
<div class="mt-1 note-div">
    ...
    <form class="mb-0" name="edit-note" method="post" action="/edit-note">
        ...
        <div class="mb-2 form-group">
            ...
            <textarea class="form-control" id="content" rows="6" cols="5" name="content"
                      required="required">${note.content}</textarea>
        </div>
        <div class="text-center"><button class="btn mt-2 text-center" type="submit">
            <fmt:message key="note.save-changes"/></button></div>
    </form>
    <div class="text-center mt-2">
        <form class="form-inline d-inline" name="delete-note" method="post" action="/delete-note">
            <input type="hidden" name="note-id" value="${note.noteId}">
            <button class="btn mr-5" type="submit"><fmt:message key="note.delete"/></button>
        </form>
    </div>
</div>